...
import { registerLmo } from '../../services/authService';
...
export default function RegisterLmoForm() {
  ...
  return (
    <form onSubmit={onSubmit} className="max-w-md mx-auto mt-10 p-6 border rounded-lg shadow-sm">
      <h1 className="text-xl font-semibold mb-4">Legal Metrology Officer (LMO) Registration</h1>
      ...
      <Field
        label="Officer Code / License Number"
        name="officerCode"
        value={form.officerCode}
        onChange={onChange}
        required
        placeholder="Departmental officer code"
      />
      ...
      <p className="text-sm mt-4 text-center">
        ...
        <Link to="/login/lmo" className="text-blue-600">
          Sign in
        </Link>
      </p>
    </form>
